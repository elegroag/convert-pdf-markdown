"""Filesystem asset exporter for DOCX images."""
...
from docx2md.domain.ports.ports import IAssetExporter
...
class FileAssetExporter(IAssetExporter):
    """Export images from DOCX to an assets directory."""
    ...
    def export(self, name: str, data: bytes) -> str:
        ...
        if self._config.convert_images_to_png and PIL_AVAILABLE:
            try:
